...
export default function CommentBox({ userName, content, likeCount, onLike }) {
  return (
    <div className="bg-light-blue text-dark-green flex flex-col p-4 rounded-md shadow-md mb-4 gap-2">
        <h1 className="font-bold text-xl m-2">{userName}</h1>
        <div className="bg-dark-green w-full h-1 rounded-md"></div>
        <div className="my-2 text-lg">{content}</div>
